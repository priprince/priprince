...
• Biometric authentication and secure login flows  
• HIPAA-level security considerations  
• Community chat and health analytics  

Built for **patients and physicians across mobile and web platforms**.
...
• Import audio from Google Drive and Dropbox  
• Cross-app audio streaming using Android Intents  
• Rust-based audio metadata integration  
• High-performance audio processing using Dart Isolates  

---

## 🧠 AI Calorie Recognition App

An **AI-powered food recognition system** for nutritional analysis.
...
• Production architecture planning for scalable AI services  
...
• Order book and live price feeds  
...
Some of the mobile applications I have contributed to and helped ship to production.
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=priprince&show_icons=true)
